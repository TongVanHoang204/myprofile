  ...
  return (
    <div className="mx-auto max-w-7xl px-4 pb-16 pt-24 sm:px-6 sm:pb-20 sm:pt-28">
      <section className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white/75 p-5 shadow-sm backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/65 sm:p-8 lg:p-10">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.05fr,0.95fr] lg:gap-10">
          <motion.div
          ...
          >
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                href={`/projects/${featuredPost.relatedProjectSlug}`}
              ...
              {copy.posts.map((post) => (
                ...
                >
                  ...
                  <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-700 dark:text-slate-200">
                    {post.credibilityPoints.slice(0, 2).map((item) => (
            ...
            return (
              ...
              >
                <motion.article
                  ...
                  className="interactive-card overflow-hidden rounded-[2rem] border border-slate-200 bg-white/75 shadow-sm backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/65"
                >
                    ...
                    <div className="space-y-5">
                      ...
                      {relatedProject ? (
                        <div className="rounded-3xl border border-slate-200 bg-slate-50/90 p-5 dark:border-slate-800 dark:bg-slate-950/70">
                          ...
                          <p className="mt-3 text-sm font-bold leading-6 text-slate-900 dark:text-slate-100">
                      ...
                      <div className="inline-flex items-center gap-2 text-sm font-bold text-sky-500 dark:text-sky-400">
                        {copy.readArticle}
                        <ArrowRight className="h-4 w-4" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50/90 p-4 dark:border-slate-800 dark:bg-slate-950/60">
                          ...
                          <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-700 dark:text-slate-200">
                            {post.credibilityPoints.map((point) => (
                              <li key={point} className="flex items-start gap-3">
                                <span className="mt-2 h-1.5 w-1.5 rounded-full bg-sky-400" />
                                <span>{point}</span>
                              </li>
