      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-10 text-center sm:mb-12">
          ...
          <motion.p
            ...
            className="text-sm leading-7 text-slate-600 dark:text-slate-400 sm:text-base"
          >
        ...
        <div className="grid gap-6 md:grid-cols-2 md:gap-12">
            ...
            <div>
              ...
              <div className="space-y-4 text-slate-600 dark:text-slate-300">
                <div className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white/50 p-4 shadow-sm transition-colors hover:border-sky-500/50 dark:border-slate-800 dark:bg-slate-900/50">
                  ...
                  <span className="break-all text-sm sm:text-base">{contactInfo.email}</span>
                </div>
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4">
                  {socialLinks.map((social) => (
                    <motion.a
                      ...
                      whileHover={{ y: -5 }}
                      className="flex min-h-11 items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 font-medium text-slate-600 shadow-sm transition-all hover:bg-sky-500 hover:text-white dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-sky-500"
                    >
          ...
          >
            ...
            <form
              ...
              className="relative rounded-2xl border border-slate-100 bg-white p-4 shadow-2xl dark:border-slate-800 dark:bg-slate-950 sm:p-8"
            >
              <input
                type="text"
                name="company"
              ...
              <div className="mb-5 space-y-2 sm:mb-6">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full rounded-xl border px-3 py-3.5 outline-none ring-2 transition-all ${
                    errors.name
              ...
              <div className="mb-4 space-y-2">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={5}
                  className={`w-full resize-none rounded-xl border px-3 py-3.5 outline-none ring-2 transition-all ${
                    errors.message
                      ? "border-red-500 bg-red-50 ring-red-500 dark:bg-red-900/10"
                      : "border-slate-200 bg-slate-50 ring-transparent hover:bg-slate-100 focus:ring-sky-500 dark:border-slate-800 dark:bg-slate-900/50 dark:hover:bg-slate-900"
                  }`}
