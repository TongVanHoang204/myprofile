          ...
          >
            <Link
              ...
              onClick={() =>
                trackContentClick({
                  kind: "blog",
                  slug: copy.posts[0].slug,
                  label: copy.posts[0].title,
                  href: `/blog/${copy.posts[0].slug}`,
                })
              }
              className="block"
                ...
                >
                  ...
                  <div className="interactive-card mt-5 rounded-3xl border border-slate-200 bg-slate-50/85 p-4 dark:border-slate-800 dark:bg-slate-950/60">
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-700 dark:text-slate-200">
                      {post.credibilityPoints[0]}
                    </p>
                  </div>

                  {relatedProject ? (
                    <div className="mt-4 rounded-3xl border border-slate-200 bg-slate-50/85 p-4 dark:border-slate-800 dark:bg-slate-950/60">
                      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">
                        {copy.relatedProjectLabel}
                      </p>
                      <p className="mt-2 text-sm font-bold leading-6 text-slate-900 dark:text-slate-100">
